                ...
                <form class="row g-3" method="POST" action="">
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <select name="idCampagne" class="form-select" id="campagne" <?php echo isset($idCampagne) ? 'disabled' : ''; ?>>
                                <?php if (isset($idCampagne)) : ?>
                                    <?php foreach ($campagnes as $campagne) : ?>
                                        <option value="<?php echo $campagne->getDocId(); ?>" <?php echo ($idCampagne == $campagne->getDocId()) ? 'selected' : ''; ?>>
                                ...
                                <?php else : ?>
                                    ...
                                    <?php foreach ($campagnes as $campagne) : ?>
                                        <option value="<?php echo $campagne->getDocId(); ?>">
                                            <?php echo $campagne->getLibelle(); ?>
                                        </option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            ...
                            <div class="form-floating mb-3">
                                <select name="idAgence" class="form-select" id="agence">
                                    ...
                                    <?php foreach ($agences as $agence) : ?>
                                        <option value="<?php echo $agence->getDocId(); ?>">
                            ...
                            <div class="form-floating mb-3">
                                <select name="idAgent" class="form-select" id="agent">
                                    <?php foreach ($agents as $agent) : ?>
                                        <option value="<?php echo $agent->getDocId(); ?>">
                        ...
                        <div class="form-floating mb-3">
                            <select name="cible" class="form-select" id="cible">
                                ...
                                <?php foreach (CIBLES_OBJECTIFS as $cible) : ?>
                                    <option value="<?php echo $cible ?>"><?php echo $cible; ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input name="dateFin" type="date" class="form-control" id="floatingDateDebut" placeholder="Date de Fin" required>
